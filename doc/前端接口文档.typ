...
#h(2.0em)——Navbar组件：提供全局导航、搜索功能和用户菜单；\
#h(2.0em)——ProductCard组件：展示单个商品信息，支持添加到购物车；\
#h(2.0em)——CartItem组件：展示购物车中的商品，支持数量调整和移除；\
#h(2.0em)——OrderCard组件：展示订单信息，支持查看详情；\
#h(2.0em)——#h(0.25em)Modal组件：通用的弹窗容器，用于登录和注册。\

= 组件接口规范

== Navbar组件（导航栏）

#h(2.0em)Navbar组件是应用的入口，提供全局导航和用户交互功能。\
#h(2.0em)该组件包括导航菜单切换、搜索功能、购物车数量显示和用户菜单等功能。\

=== Props（属性）

#align(center)[#text(10.5pt, font: "SimHei")[表#h(0.25em)1#h(1.0em)Navbar组件Props]]
...
#align(center)[#text(10.5pt, font: "SimHei")[表#h(0.25em)2#h(1.0em)Navbar组件Events]]
...
#h(2.0em)ProductCard组件用于显示单个商品信息，支持悬停效果和添加到购物车功能。\
#h(2.0em)商品卡片包含商品图片、名称、价格和评分信息。\

=== Props（属性）

#align(center)[#text(10.5pt, font: "SimHei")[表#h(0.25em)3#h(1.0em)ProductCard组件Props]]
...
#align(center)[#text(10.5pt, font: "SimHei")[表#h(0.25em)4#h(1.0em)ProductCard组件Events]]
...
#h(2.0em)CartItem组件用于显示购物车中的单个商品，支持数量调整和移除功能。\
#h(2.0em)购物车商品组件实时计算商品总价。\

=== Props（属性）

#align(center)[#text(10.5pt, font: "SimHei")[表#h(0.25em)5#h(1.0em)CartItem组件Props]]
...
#align(center)[#text(10.5pt, font: "SimHei")[表#h(0.25em)6#h(1.0em)CartItem组件Events]]
...
#h(2.0em)OrderCard组件用于显示单个订单信息，支持订单状态显示和详情查看功能。\
#h(2.0em)订单状态包括：待处理、处理中、已发货、已送达。\

=== Props（属性）

#align(center)[#text(10.5pt, font: "SimHei")[表#h(0.25em)7#h(1.0em)OrderCard组件Props]]
...
#align(center)[#text(10.5pt, font: "SimHei")[表#h(0.25em)8#h(1.0em)OrderCard组件Events]]
...
#h(2.0em)Modal组件是通用的弹窗容器，支持遮罩层、关闭功能和标题显示。\
#h(2.0em)模态框用于登录和注册功能。\

=== Props（属性）

#align(center)[#text(10.5pt, font: "SimHei")[表#h(0.25em)9#h(1.0em)Modal组件Props]]
...
#align(center)[#text(10.5pt, font: "SimHei")[表#h(0.25em)10#h(1.0em)Modal组件Events]]
...
#align(center)[#text(10.5pt, font: "SimHei")[表#h(0.25em)11#h(1.0em)localStorage键值规范]]
...
#align(center)[#table(
  ...
  [#text(9pt, font: "Times New Roman")[JSON字符串]],
...
#h(2.0em)├──#h(0.5em)components/#h(1.0em)Vue组件目录\
...
#h(2.0em)系统需要开放以下端口：\
#h(2.0em)——80端口：Http访问；\
#h(2.0em)——443端口：Https访问（可选）；\
#h(2.0em)——3306端口：数据库访问（如果连接后端）；\
#h(2.0em)——6379端口：#h(0.25em)Redis访问（如果使用缓存）。\
