...
#set page(
  numbering: "I",
  header: [
    #place(top + center, dy: 25mm)[#text(10.5pt, font: "SimHei")[购物商城系统——手动测试检查清单]]
...
#h(2.0em)本测试检查清单旨在为测试人员提供完整的购物商城系统手动测试指南。\
#h(2.0em)文档涵盖了测试环境、基础测试、功能测试和测试结果记录等内容。\
#h(2.0em)购物商城系统是一个基于Vue#h(0.25em)3的现代化组件化应用，采用Nginx作为Web服务器，支持完整的电商购物流程。\
#h(2.0em)通过本检查清单，测试人员将能够全面了解平台的测试要点和验收标准，确保系统功能正常、性能稳定。\
#h(2.0em)我们希望本检查清单能够帮助测试人员高效、全面地完成购物商城系统的测试工作。\
...
#h(2.0em)我们将持续更新和完善本检查清单，以帮助用户更好地测试购物商城系统。\
...
#h(2.0em)购物商城系统需要特定的测试环境支持，确保测试结果的准确性和可重复性。\
#h(2.0em)测试环境包括服务器环境、框架版本和组件依赖等。\

== 服务器配置

#h(2.0em)购物商城系统使用Nginx作为Web服务器，提供静态文件服务。\
#h(2.0em)服务器配置如下：\
...
#h(2.0em)功能测试验证购物商城系统的各项功能是否正常工作。\
