@echo off
REM =============================================
REM Database Test Script for CMD using JDK 22
...
rem Set the Java executable to JDK 22
set "JAVA_EXE=C:\Program Files\Java\jdk-22\bin\java.exe"

if not exist "%JAVA_EXE%" (
    echo Error: JDK 22 not found at %JAVA_EXE%
    popd
    exit /b 1
)
...
"%JAVA_EXE%" -cp "%H2_JAR%" org.h2.tools.RunScript -url jdbc:h2:mem:testdb -user sa -password -script "%SQL_FILE%"
