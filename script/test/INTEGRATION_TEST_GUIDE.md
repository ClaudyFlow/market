...
| 文件 | 用途 |
|------|------|
| `../../backend/src/test/resources/application-integration.properties` | 后端联调测试配置 |
| `../../backend/src/test/resources/data-integration-test.sql` | 测试数据初始化 |
